't" t
.TH sphz 1 "January 2009" UNIX "NagBody PROJECT"
.na
.nh   

.SH NAME
\fBsphz\fR - (Direct force calculation) simulation of a 
selfgravitating N-body system

.SH SYNOPSIS
\fBsphz\fR [ \fIparameter_file_name\fR ] [ \fIoptions\fR ] 
.sp

.SH DESCRIPTION
\fBsphz\fR - Simulates the evolution of a N-body system interacting with a potential
proportional to 1/r.
...
.sp 
sphz parameters_input_file_name
.sp
...
sphz
.sp
This will run the \fBsphz\fR code with default values generating
a test data set internally,
and when it finish you will have in your
running directory the file "parameters_null-sphz-usedvalues".
...
Once the \fBsphz\fR is running you may always stop it by executing the command
...
.br
sphz nbody=4096 dtime=1/32 out=snap%03d
