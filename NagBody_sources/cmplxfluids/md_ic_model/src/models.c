/*==============================================================================
	MODULE: models.c				[md_ic_model]
	Written by: M.A. Rodriguez-Meza
	Starting date: Enero 2012
	Purpose: Initialize md_blj
	Language: C
	Use: 'startrun();'
...
local void testdata_hexagonal(void);			// HEXAGONAL structure ...
...
#define HEXAGONAL_IC	7				// HEXAGONAL structure ...
...
void testdata(void)
{
    switch(cmd.icModel) {
        ...
        case HEXAGONAL_IC:						// HEXAGONAL structure ... 2D
            testdata_hexagonal(); break;
        case NULLMETHOD:
            printf("\n\tdefault IC ...\n");
...
local void testdata_hexagonal(void)			// FCC structure default ... 2D
{
// Rayo (COMIENZO):
	FILE *fpt;
...
//
	...
	fprintf(gd.outlog,
			"\ntestdata_hexagonal: hexagonal structure : hexagonal simple (HCP)\n");
	
    strcpy(gd.model_comment, "Simple Hexagonal Box Model [7] (HCP) created");
	...
	for(iiz=0; iiz<=cz; iiz++){
		...
		for(iiy=0; iiy<=cy; iiy++)	{
			...
			for(iix=0; iix<=cx; iix++)	{
				r1x=r1x0+a*xx;	r1y=r1y0+yy*1.73205;		r1z=r1z0+zz*ch;
				r2x=r2x0+a*xx;	r2y=r2y0+yy*1.73205;		r2z=r2z0+zz*ch;
				r3x=r3x0+a*xx;	r3y=r3y0+yy*1.73205;		r3z=r3z0+zz*ch;
			...
			r1x=r1x0+a*xx;	r1y=r1y0+yy*1.73205;		r1z=r1z0+zz*ch;
			r2x=r2x0+a*xx;	r2y=r2y0+yy*1.73205;		r2z=r2z0+zz*ch;	
			r3x=r3x0+a*xx;	r3y=yy*1.73205;		r3z=r3z0+zz*ch;	
			...
			for(iix=0; iix<=cx+1; iix++)	{
				r1x=r3x0+a*xx;	r1y=1.1547+yy*1.73205;		r1z=r1z0+zz*ch;
