...
int lasti = -1;       /* remember index of last invocation */

void splsub(double*, double*, double*, double*, double*, int);
int interval(double, double *, int);
...
void spline(double *coef, double *x, double *y, int n)
{
...
void splsub(
    double b[], double c[], double d[],   /* 1st to 3rd order polynomial coefs */
    double x[], double y[],
    int n)
{
    int i;
...
double seval(double x0, double *x, double *y, double *coef, int n)
{
    int i;
    double u;
...
double spldif(double x0, double *x, double *y, double *coef, int n)
{
    int i;
    double u;
...
double spldif2(double x0, double *x, double *y, double *coef, int n)
{
    int i;
    double u;
 ...
 *           use the edge data
 */
int interval(double u, double *x, int n)
{
    int i, j, k;
