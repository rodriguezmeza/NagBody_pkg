...
#include "../lib/maxsizes.h"   /* should be in $NEMOLIB - made during install */
#include "version.h"	/* our static version id - made during install */
#include "../lib/config.h"     /* should be in $NEMOLIB - made during install */
...
extern stream nstropen(const_string, string);
