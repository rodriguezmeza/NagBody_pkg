...
.SH NAME
\fBgalaxy_starscream\fR - (IC) Initial condition generator of a
galaxy

.SH SYNOPSIS
\fBgalaxy_starscream\fR [ \fIparameter_file_name\fR ] [ \fIoptions\fR ]
.sp

.SH DESCRIPTION
\fBgalaxy_starscream\fR - Simulates the evolution of a N-body system interacting with a potential
proportional to 1/r.
