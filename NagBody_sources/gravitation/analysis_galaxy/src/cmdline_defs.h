/* ==============================================================================
	HEADER: cmdline_defs.h			[analysis_galaxy]
...
#define HEAD2	"Code for data analysis of a galaxy model simulation"
...
//
	"cmpos1=0:0:0",			";Model 1 center of mass position for composed model",
	"cmvel1=0:0:0",			";Model 1 center of mass velocity for composed model",
	"cmpos2=0:0:0",			";Model 2 center of mass position for composed model",
	"cmvel2=0:0:0",			";Model 2 center of mass velocity for composed model",
//
	...
	"fsnap=0",				";Final snap number (by default just one time)",
    "options=",             ";Various control options (save, snap_cgm, rdf_cgm, vel_cgm)", ":opt",
    "analysis_type=",		";Data analysis type to be done (snap_anim, snap_planim, rdf_anim, ...)", ":at",
//
