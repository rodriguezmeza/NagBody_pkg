 ...
 * Most applications will realize only some components. 
 */
...
ps_field phatbody[MaxBodyFields] = {
    ...
    { IntType,   KeyTag,      BadOffset,  0 },		/* = phatbody[16]   */
    { RealToke,  AuxTag,      BadOffset,  0 },		/* = phatbody[17]   */
    { VectToke,  AuxVecTag,   BadOffset,  0 },		/* = phatbody[18]   */
    { NULL,      NULL,        0,          0 },	
};
