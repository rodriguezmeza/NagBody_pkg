/*==============================================================================
	MODULE: md_blj_io.c			[md_blj_n2_sird]
...
// SIRD:
//local int SuscSumSave;        // BORRAR
local int InfSumAcumSave;
local int RelSumSave;
local int DeathSumSave;
//
...
// SIRD:
fprintf(outstr_thermo,"%9s%8s%8s%8s%8s","Susc","InfT","RelT","DeathT","InfAcum");
fprintf(outstr_thermo,"%9s%8s%8s%8s%8s","RelDeathT","psInf","psRel","psDeath","psRelDeath");
//
...
// SIRD:
fprintf(outstr_thermo,"%8s%8s%8s%8s%8s","<20>","<21>","<22>","<23>","<24>");
fprintf(outstr_thermo,"%8s%8s%8s%8s%8s","<25>","<26>","<27>","<28>","<29>");
//
		if (cmd.computeChemPot)
...
//        InfSumAcumSave = 0;
//        RelSumSave = 0;
//        SuscSumSave = gd.SuscSum;
        InfSumAcumSave = gd.InfSum;
        RelSumSave = gd.RelSum;
        DeathSumSave = gd.DeathSum;
//
		AccumProps(0);
    }
...
// SIRD:
//    gd.Susc = ((real)(gd.SuscSum - SuscSumSave));
//    gd.Susc = ((real)(gd.SuscSum));
//    SuscSumSave = gd.SuscSum;
    gd.Inf = ((real)(gd.InfSumAcum - InfSumAcumSave));
    InfSumAcumSave = gd.InfSumAcum;
    gd.Rel = ((real)(gd.RelSum - RelSumSave));
    RelSumSave = gd.RelSum;
    gd.Death = ((real)(gd.DeathSum - DeathSumSave));
    DeathSumSave = gd.DeathSum;
    gd.RelDeathSum = gd.RelSum + gd.DeathSum;
//
...
local void AccumProps(int icode)						// CHECK 2D --- OK!!!
{
	...
	if (icode == 0) {
// SIRD:
//        gd.sSusc = gd.ssSusc = 0.0;
//        gd.sInf = gd.ssInf = 0.0;
//        gd.sRel = gd.ssRel = 0.0;
//        gd.sDeath = gd.ssDeath = 0.0;
        gd.sInf = 0.0;
        gd.sRel = 0.0;
        gd.sDeath = 0.0;
//
...
//        gd.sSusc = gd.Susc;
        ...
        gd.sRel += gd.Rel;
        gd.sDeath += gd.Death;
        gd.sRelDeath = gd.sRel+gd.sDeath;
//
...
// SIRD:
//        gd.sInf = gd.sInf/stepAvg;
//        gd.ssInf = rsqrt((gd.ssInf>rsqr(gd.sInf) ?
//            gd.ssInf - rsqr(gd.sInf) : 0) );
//        gd.ssInf = rsqrt((gd.ssInf/stepAvg>rsqr(gd.sInf) ?
//            gd.ssInf/stepAvg - rsqr(gd.sInf) : 0) );
//
...
// SIRD:
    fprintf(outstr_thermo," %d %d %d %d %d %d %g %g %g %g",
            gd.SuscSum,gd.InfSum,gd.RelSum,gd.DeathSum,gd.InfSumAcum,
            gd.RelDeathSum,gd.sInf,gd.sRel,gd.sDeath,gd.sRelDeath);
// Tests: Comentar despues de probar... son las columnas 30 y 31
    fprintf(outstr_thermo," %d %g",
        gd.SuscSum+gd.InfSum+gd.RelSum+gd.DeathSum,
        gd.sInf+gd.sRel+gd.sDeath);
//
    fprintf(outstr_thermo,"\n");
    fclose(outstr_thermo);
...
// SIRD:
    safewrite(&cmd.adjustSIRD, sizeof(bool), str);
    safewrite(&cmd.infectedRelaxtionTimeD, sizeof(real), str);
    safewrite(&cmd.infectedRelaxtionTimeR, sizeof(real), str);
    safewrite(&cmd.infectionProb, sizeof(real), str);
    safewrite(&cmd.infectionMinDist, sizeof(real), str);
    safewrite(&gd.SuscSum, sizeof(int), str);
    safewrite(&gd.InfSum, sizeof(int), str);
    safewrite(&gd.RelSum, sizeof(int), str);
    safewrite(&gd.DeathSum, sizeof(int), str);
    safewrite(&gd.InfSumAcum, sizeof(int), str);
    safewrite(&gd.RelDeathSum, sizeof(int), str);

    safewrite(&InfSumAcumSave, sizeof(int), str);
    safewrite(&RelSumSave, sizeof(int), str);
    safewrite(&DeathSumSave, sizeof(int), str);

//    safewrite(&gd.Susc, sizeof(real), str);
//    safewrite(&gd.sSusc, sizeof(real), str);
    safewrite(&gd.Inf, sizeof(real), str);
    safewrite(&gd.sInf, sizeof(real), str);
    safewrite(&gd.Rel, sizeof(real), str);
    safewrite(&gd.sRel, sizeof(real), str);
    safewrite(&gd.Death, sizeof(real), str);
    safewrite(&gd.sDeath, sizeof(real), str);
    safewrite(&gd.sRelDeath, sizeof(real), str);
...
// SIRD:
    saferead(&cmd.adjustSIRD, sizeof(bool), str);
    saferead(&cmd.infectedRelaxtionTimeD, sizeof(real), str);
    saferead(&cmd.infectedRelaxtionTimeR, sizeof(real), str);
    saferead(&cmd.infectionProb, sizeof(real), str);
    saferead(&cmd.infectionMinDist, sizeof(real), str);
    saferead(&gd.SuscSum, sizeof(int), str);
    saferead(&gd.InfSum, sizeof(int), str);
    saferead(&gd.RelSum, sizeof(int), str);
    saferead(&gd.DeathSum, sizeof(int), str);
    saferead(&gd.InfSumAcum, sizeof(int), str);
    saferead(&gd.RelDeathSum, sizeof(int), str);

    saferead(&InfSumAcumSave, sizeof(int), str);
    saferead(&RelSumSave, sizeof(int), str);
    saferead(&DeathSumSave, sizeof(int), str);

//    saferead(&gd.Susc, sizeof(real), str);
//    saferead(&gd.sSusc, sizeof(real), str);
    saferead(&gd.Inf, sizeof(real), str);
    saferead(&gd.sInf, sizeof(real), str);
    saferead(&gd.Rel, sizeof(real), str);
    saferead(&gd.sRel, sizeof(real), str);
    saferead(&gd.Death, sizeof(real), str);
    saferead(&gd.sDeath, sizeof(real), str);
    saferead(&gd.sRelDeath, sizeof(real), str);
