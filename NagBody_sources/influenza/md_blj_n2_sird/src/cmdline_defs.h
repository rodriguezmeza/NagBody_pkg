/*==============================================================================
	HEADER: cmdline_defs.h				[md_blj_n2]
	Written by: M.A. Rodriguez-Meza
	Starting date: February 2005
	Purpose: Definitions for importing arguments from the command line
	Language: C
	Use: '#include "...."
	Use in routines and functions: md_blj_n2 (main)
...
string defv[] = {  ";"HEAD1": " HEAD2 "\n\t " HEAD3,
    ...
    "forcecalc_method=direct2",	";Force calculation method to use", ":fm",
...
//
// SIRD:
    "adjustSIRD=true",                     ";Adjust SIRD tags of the bodies  (SIRD evolution)",
    "infectedRelaxtionTimeD=20.0",         ";Infected relaxation time to be death  (SIRD evolution)",
    "infectedRelaxtionTimeR=20.0",         ";Infected relaxation time to be release  (SIRD evolution)",
    "infectionProb=0.5",                    ";Infection probability at contact  (SIRD evolution)",
    "infectionMinDist=0.95",                 ";Minimum infection distance to an infected body  (SIRD evolution)",
//
...
// SIRD:
    "icModel=7",                ";IC method (1, 2, 3, 4, 5, 6 and 7). Run with tstop=0 to see details",
    "seed=123",                 ";Random number seed for test run",
//
#ifdef THREEDIM
	"unitCells=8:8:8",			";Number of unit cells along axes (icModel=6)", ":uC",
#else
	"unitCells=8:8",			";Number of unit cells along axes (icModel=6)", ":uC",
#endif
// CHATO:
