...
//// SIRD: (could be use in 3D also, but for developing use 2D)
...
// BEGIN: SIRD:
    bool adjustSIRD;
    real infectedRelaxtionTimeD;
    real infectedRelaxtionTimeR;
    real infectionProb;
    real infectionMinDist;
// END: SIRD:
...
// SIRD:
//    real sTotSusceptibles;      // Accumulated all these variables.
//    real sTotInfected;
//    real sTotReleased;
//    real sTotDeath;
    int SuscSum;
