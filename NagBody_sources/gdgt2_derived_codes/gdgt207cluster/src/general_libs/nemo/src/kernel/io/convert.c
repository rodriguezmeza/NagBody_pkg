...
{
    if (from==NULL) nerror("convert_d2f: illegal from=NULL address");
    if (to==NULL)   nerror("convert_d2f: illegal to=NULL address");
    if (n<1) return 0;
...
{
    if (from==NULL) nerror("convert_f2d: illegal from=NULL address");
    if (to==NULL)   nerror("convert_f2d: illegal to=NULL address");
    if (n<1) return 0;
