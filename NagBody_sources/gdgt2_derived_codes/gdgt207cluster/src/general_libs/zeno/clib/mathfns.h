 ...
 * role of <math.h>.  Defines real-valued synonyms for system functions
 * (eg, rsqrt for square root) and zeno functions (eg, seval), depending
 * on precision switch (MIXEDPREC, SINGLEPREC, or DOUBLEPREC).
 */
...
/*
 * System math functions.  Use double-precision versions in
 * both double and mixed precision.
 */
 ...
 * in all three variants.  See also "vectdefs.h".
 */
