/*==============================================================================
	HEADER: cmdline_defs.h			[gdgt207gassphere]
...
//
    ...
    "InitCondFile=./ICs/gassphere_littleendian.dat",		";File with IC", ":ic",
    "OutputDir=gassphere/",						";Simulation working directory",
...
//
    "ResubmitCommand=xyz",				";Resubmit command",
    ...
    "CpuTimeBetRestartFile=3600",		";Cpu time to save a state run (here in seconds)",
    ...
    "TimeBetSnapshot=0.2",			";Time to save a snapshot",
    "UnitVelocity_in_cm_per_s=1.0",		";Velocity unit in cm/s",
    "UnitLength_in_cm=1.0",				";Length unit in cm",
    "UnitMass_in_g=1.0",				";Mass unit in 1 x 10^10 solar masses",
    "GravityConstantInternal=1.0",		";Constant G internal value",
    "ErrTolIntAccuracy=0.05",			";Internal tolerance accuracy",
    "ErrTolTheta=0.5",					";Opening parameter value",
    "ErrTolForceAcc=0.005",				";Tolerance for force-acc",
    "MaxSizeTimestep=0.02",			";Maximum time step",
    "MinSizeTimestep=0",				";Minimum time step",
    "MaxRMSDisplacementFac=0.25",				";Maximum RMS displacement factor",
    "DesNumNgb=50",						";Desired number of neighbours",
    "MaxNumNgbDeviation=1",				";Maximum number of neighbours deviation",
...
//
    "MinGasHsmlFractional=0",			";Minimum fraction in gas smoothing",
    "ArtBulkViscConst=0.8",				";Artificial bulk viscosity constant",
    "CourantFac=0.1",						";Courant factor",
...
//
    ...
    "SofteningGasMaxPhys=0.004",			";Maximum physical softening for gas particles",
