...
#define KeyField       phatbody[16]
#define AuxField       phatbody[17]
#define AuxVecField    phatbody[18]

#define NewBodyFields 19			/* index of 1st free field  */
