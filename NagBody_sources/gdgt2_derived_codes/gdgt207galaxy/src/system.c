...
//
// ESTA DEFINIDO EN General_libs/general/clib.c
//
 ...
 */
//double timediff(double t0, double t1)           // Defined in General_libs/general/clib.c
//{
//  double dt;
//
//  dt = t1 - t0;
...
// Defined in General_libs/math/mathutil.c
