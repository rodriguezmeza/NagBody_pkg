...
2. To install the binary and man page md_blj_n2 files execute the command
...
to get the md_blj_n2 help menu or

man md_blj_n2

to get the corresponding man page. Or you may go to the directory

> cd NagBody_Tests/Cmplxfluids/md_blj_n2

and there run the md_blj_n2 code with the default options:

> md_blj_n2

When funish running you will have several files. You may also run as

> md_blj_n2 computeRdf=true
