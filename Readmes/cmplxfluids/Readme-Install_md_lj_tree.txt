...
2. To install the binary and man page md_lj_tree files execute the command
...
to get the md_lj_tree help menu or

man md_lj_tree

to get the corresponding man page. Or you may go to the directory

> cd NagBody_Tests/Cmplxfluids/md_lj_tree

and there run the md_lj_tree code with the default options:

> md_lj_tree

When funish running you will have several files. You may also run as

> md_lj_tree computeRdf=true
