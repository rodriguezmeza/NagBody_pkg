...
3. To install the binary and man page analysis_md files execute the command
...
to get the analysis_md help menu or

man analysis_md

to get the corresponding man page. Or you may go to the directory

cd NagBody_Tests/Cmplxfluids/analysis_md

and there run the analysis_md code with the default options:
