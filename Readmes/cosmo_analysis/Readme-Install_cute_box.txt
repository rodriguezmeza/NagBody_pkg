...
5. To install the binary and man page cute_box files execute the command

> make -f NagBody install_cute_box

With this command you will have a running binary and its man page. Now, you may try it. Go to directory: 

> cd $HOME/NagBody_pkg/NagBody_Tests/cosmo_analysis/cute_box/

> cute_box params_file
