...
5. To install the binary and man page powmes files execute the command

> make -f NagBody install_powmes

With this command you will have a running binary and its man page. Now, you may try it. Go to directory: 

> cd $HOME/NagBody_pkg/NagBody_Tests/Gravitation/powmes.0.2/

> powmes powmes.config.template
