...
To install fftw-2.x.x see the corresponding readme file: 

$(NAGBODYDIR)/Readmes/Additional_libs/Readme-Install_fftw-2
...
5. To install the binary and man page rockstar files execute the command

> make -f NagBody install_rockstar

With this command you will have a running binary and its man page. Now, you may try it. Go to directory: 

> cd $HOME/NagBody_pkg/NagBody_Tests/cosmo_analysis/rockstar/

> rockstar rockstar.config.template

the files powspec.dat and powspec.dat.template should not differ from
each other more that at the single accuracy level.
