...
3. To install the binary and man page 2lptic_za_only files execute the command

> make -f NagBody install_2lptic_za_only

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/Gravitation/2lptic_za_only run 

> mpirun -np 2 2lptic_za_only 2lpt_Carmen.param > output &
