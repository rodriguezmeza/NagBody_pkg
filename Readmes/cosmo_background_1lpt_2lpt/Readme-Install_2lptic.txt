...
3. To install the binary and man page 2lptic files execute the command

> make -f NagBody install_2lptic

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/Gravitation/2lptic run 

> mpirun -np 2 2lptic 2lpt_Carmen.param > output &
