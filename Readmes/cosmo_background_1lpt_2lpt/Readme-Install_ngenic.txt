...
3. To install the binary and man page n-genic files execute the command

> make -f NagBody install_n-genic

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/Gravitation/n-genic run 

> mpirun -np 2 n-genic ics.param > output &
