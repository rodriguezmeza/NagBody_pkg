...
3. To install the binary and man page gdgt207cluster files execute the command
...
> mpirun -np 4 gdgt207cluster parameterfile > output &

The parameter file must be consistent with the type of simulation you generate.

You may test the code É go to directory "NagBody_Tests/gdgt2_derived_codes/gdgt207cluster/Ò. There read the readme file for instructions.
