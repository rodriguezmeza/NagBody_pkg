...
3. To install the binary and man page galic files execute the command
...
> mpirun -np 4 galic parameterfile > output &

The parameter file must be consistent with the type of simulation you generate.

You may test the code É go to directory "NagBody_Tests/gdgt2_derived_codes/galic/". There read the readme file for instructions.
