...
3. To install the binary and man page sphz files execute the command

make -f NagBody install_sphz
...
to get the sphz help menu or

man sphz

to get the corresponding man page. Or you may go to the directory

cd NagBody_Tests/Gravitation/sphz

and there run the sphz code with the default options:
