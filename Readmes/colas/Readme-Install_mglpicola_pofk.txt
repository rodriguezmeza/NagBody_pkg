...
3. To install the binary and man page mglpicola_pofk files execute the command

> make -f NagBody mglpicola_pofk

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/colas/mglpicola_pofk run 

> mpirun -np 2 mglpicola_pofk in.param > output &
