mglpicola_pofkAll INSTALL PARTICLE DYNAMICS PROJECT (NagBody)
...
mglpicola_pofk_rsd_mpi INSTALLATION
...
3. To install the binary and man page mglpicola_pofk_rsd_mpi files execute the command

> make -f NagBody mglpicola_pofk_rsd_mpi

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/colas/mglpicola_pofk_rsd_mpi run 

> mpirun -np 2 mglpicola_pofk_rsd_mpi in.param > output &
