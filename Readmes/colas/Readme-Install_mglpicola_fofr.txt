...
3. To install the binary and man page mglpicola_fofr files execute the command

> make -f NagBody mglpicola_fofr

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/colas/mglpicola_fofr run 

> mpirun -np 2 mglpicola_fofr in.param > output &
