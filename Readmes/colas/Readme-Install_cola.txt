...
3. To install the binary and man page lpicola files execute the command

> make -f NagBody lpicola

With this command you will have a running binary and its man page. 

Now, you may go to directory NagBody_Tests/colas/lpicola run 

> mpirun -np 2 lpicola in.param > output &
