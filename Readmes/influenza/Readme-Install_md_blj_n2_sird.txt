...
2. To install the binary and man page md_blj_n2_sird files execute the command

> make -f NagBody install_md_blj_n2_sird
...
to get the md_blj_n2_sird help menu or

man md_blj_n2_sird

to get the corresponding man page. Or you may go to the directory

> cd NagBody_Tests/influenza/md_blj_n2_sird

and there run the md_blj_n2_sird code with the default options:

> md_blj_n2_sird

When funish running you will have several files. You may also run as

> md_blj_n2_sird computeRdf=true
