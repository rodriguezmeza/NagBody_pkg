...
3. To install the binary and man page galaxy_models files execute the command

make -f NagBody install_galaxy_models
...
to get the galaxy_models help menu or

man galaxy_models

to get the corresponding man page. Or you may go to the directory

cd NagBody_Tests/Gravitation/galaxy_models

and there run the galaxy_models code with the default options:
